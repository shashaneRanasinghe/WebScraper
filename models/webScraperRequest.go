...
type Headers struct {
	H1Count int16 `json:"h1_Count"`
	H2Count int16 `json:"h2_Count"`
	H3Count int16 `json:"h3_Count"`
	H4Count int16 `json:"h4_Count"`
	H5Count int16 `json:"h5_Count"`
	H6Count int16 `json:"h6_Count"`
}
